				...
				<div class="span3">
					<div class="well" style="padding: 8px 0;">
						<ul class="nav nav-list">
							...
							<li class="active">
								<a href="usermanagement.html"><i class="icon-white icon-home"></i> 管理用户</a>
							</li>
							<li>
								<a href="usergroupmanagement.html"><i class="icon-folder-open"></i>管理用户组</a>
							</li>
							<li class="nav-header">
								在线内容节点管理
							</li>
							<li>
								<a href="nodemanagement.html"><i class="icon-picture"></i> 节点管理</a>
							</li>
							<li>
								<a href="statusmaintenance.html"><i class="icon-stop"></i> 状态维护</a>
							</li>
							<li class="nav-header">
								流量和缓存信息
							</li>
							<li>
								<a href="cachecontent.html"><i class="icon-picture"></i> 缓存内容管理</a>
							</li>
							<li>
								<a href="overallflow.html"><i class="icon-stop"></i> 总体流量信息</a>
							</li>
							<li>
								<a href="httpflow.html"><i class="icon-picture"></i> http流量信息</a>
							</li>
							<li>
								<a href="pictureflow.html"><i class="icon-stop"></i> 图片类流量信息</a>
							</li>
							<li>
								<a href="appflow.html"><i class="icon-picture"></i>App类流量信息</a>
							</li>
							<li>
								<a href="flowdistribution.html"><i class="icon-stop"></i> 各协议的流量分布信息</a>
							</li>
							<li>
							...
							<li>
								<a href="serviceexpress.html"><i class="icon-picture"></i> 服务展示</a>
							</li>
						</ul>
					</div>
				</div>
